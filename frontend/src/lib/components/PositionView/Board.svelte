...
<g transform={`translate(${x}, ${y})`}>
  ...
  <circle cx="742.5" cy="802.5" r="12.5" fill="#666" />
  <circle cx="1477.5" cy="802.5" r="12.5" fill="#666" />
  <circle cx="742.5" cy="1597.5" r="12.5" fill="#666" />
  <circle cx="1477.5" cy="1597.5" r="12.5" fill="#666" />
</g>
